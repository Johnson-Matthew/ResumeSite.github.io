...
var Wn = [createBaseVNode("path", { d: "M224 0c-35.3 0-64 28.7-64 64V288c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64H224zM64 160c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H288c35.3 0 64-28.7 64-64V384H288v64H64V224h64V160H64z" }, null, -1)];
var En = [createBaseVNode("path", { d: "M470.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L192 338.7 425.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }, null, -1)];
var Ln = [createBaseVNode("path", { d: "M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z" }, null, -1)];
var pn = defineComponent({ __name: "StatusIcons", props: { icon: { type: String, required: true } }, setup: (r) => (t, b) => r.icon === "copy" ? (openBlock(), createElementBlock("svg", mergeProps({ key: 0 }, t.$attrs, { viewBox: "0 0 512 512", xmlns: "http://www.w3.org/2000/svg" }), Wn, 16)) : r.icon === "success" ? (openBlock(), createElementBlock("svg", mergeProps({ key: 1 }, t.$attrs, { viewBox: "0 0 512 512", xmlns: "http://www.w3.org/2000/svg" }), En, 16)) : r.icon === "failed" ? (openBlock(), createElementBlock("svg", mergeProps({ key: 2 }, t.$attrs, { viewBox: "0 0 320 512", xmlns: "http://www.w3.org/2000/svg" }), Ln, 16)) : createCommentVNode("", true) });
function An(r) {
  return { name: "Plain text", aliases: ["text", "txt"], disableAutodetect: true };
}
var Fn = { class: "v-code-block--button-copy" };
var In = { class: "v-code-block--button-run" };
var Gn = { class: "v-code-block--code" };
var Jn = ["textContent"];
var On = ["innerHTML"];
var Rn = ((r, t) => {
  ...
  const x = ref(null), h = ref("copy"), T = ref(""), F = ref(false), I = ref(false), C = ref(false), mn = ref("https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.8.0/build/styles"), Y = ref("https://cdn.jsdelivr.net/gh/PrismJS/prism@1.29.0/themes"), dn = ref("https://cdn.jsdelivr.net/gh/PrismJS/prism-themes@1.9.0/themes"), M = ref(""), G = ref(""), j = ref(""), { copyButton: kn, copyIcons: fn, copyTab: K, label: Q, runTab: X, tabs: N } = toRefs(e.value), _n = computed(() => {
    ...
    const { copyStatus: s, highlightjs: o, useTheme: l } = a, y = cn(unref(o)), v = jn(unref(l));
    ...
    const { highlightjs: s, useTheme: o } = a, l = cn(unref(s)), y = jn(unref(o));
  ...
  function ln() {
    ...
    if (v = on(s, v), y === j.value || y === v || typeof j.value == "boolean") return;
...
`);
    ...
    if (!S && !z) return rn(), l.appendChild(document.createTextNode(a)), void o.appendChild(l);
    const un = on(s, j.value);
    if (e.value.cssPath !== void 0) _ = e.value.cssPath;
    else switch (s) {
      case "highlightjs":
        p = `${un}.min.css`, _ = `${mn.value}/${p}`;
        break;
      case "prism":
        p = `${un}.css`, _ = j.value === "default" ? `${Y.value}/prism.css` : j.value.includes("themes-") ? `${dn.value}/${p}` : `${Y.value}/prism-${p}`;
        break;
      default:
        p = "";
    }
    I.value = true, fetch(_).then((B) => B.text()).then((B) => {
      rn(), l.appendChild(document.createTextNode(B)), o.appendChild(l), I.value = false;
    }).catch((B) => {
      const Sn = e.value.highlightjs ? "Highlight.js" : "PrismJS";
  ...
  function tn() {
    (function() {
      if (e.value.lang !== "json") x.value = e.value.code;
      else {
        const a = e.value.code.toString();
        x.value = JSON.stringify(JSON.parse(a), null, e.value.indent);
      }
    })(), e.value.highlightjs && import("./es-E4QDI6C7.js").then((a) => {
      L = a.default, L.registerLanguage("plain", An), M.value = L.highlight(x.value, { language: e.value.lang }).value;
    }).catch((a) => {
